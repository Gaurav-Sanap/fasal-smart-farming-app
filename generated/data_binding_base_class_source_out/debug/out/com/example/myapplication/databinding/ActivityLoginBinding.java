...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final Button createAccountLink;
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull Button createAccountLink,
      @NonNull TextInputEditText emailInput, @NonNull TextInputLayout emailLayout,
      @NonNull TextView forgotPasswordLink, @NonNull Button loginButton,
      @NonNull MaterialCardView logoCard, @NonNull TextInputEditText passwordInput,
      @NonNull TextInputLayout passwordLayout, @NonNull TextView welcomeText) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.create_account_link;
      Button createAccountLink = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, createAccountLink, emailInput,
          emailLayout, forgotPasswordLink, loginButton, logoCard, passwordInput, passwordLayout,
          welcomeText);
    }
