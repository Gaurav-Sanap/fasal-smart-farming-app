...
public final class ActivityChatbotBinding implements ViewBinding {
  ...
  private ActivityChatbotBinding(@NonNull RelativeLayout rootView,
      @NonNull RecyclerView chatRecyclerView, @NonNull RelativeLayout inputLayout,
  ...
  public static ActivityChatbotBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout inputLayout = ViewBindings.findChildViewById(rootView, id);
      if (inputLayout == null) {
        break missingId;
      }
      ...
      return new ActivityChatbotBinding((RelativeLayout) rootView, chatRecyclerView, inputLayout,
